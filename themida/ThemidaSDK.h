...
// ***********************************************
 ...
 DLL_IMPORT void STDCALL_CONVENTION _ryptStart(void);

 DLL_IMPORT void STDCALL_CONVENTION _ryptEnd(void);

 DLL_IMPORT void STDCALL_CONVENTION _ryptWStart(void);

 DLL_IMPORT void STDCALL_CONVENTION _ryptWEnd(void);
...
// ***********************************************
 ...
 #define STR_ENCRYPT_START _ryptStart();
 #define STR_ENCRYPT_END _ryptEnd();

 #define STR_ENCRYPTW_START _ryptWStart();
 #define STR_ENCRYPTW_END _ryptWEnd();
